                        ...
                        <div className="grid md:grid-cols-2">
                            <div className="h-full pr-6">
                                <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                                    GRR's superior candidate screening process ensures the most suitable candidates are presented to you,
                                    leading to a higher hiring success rate.
                                </p>
                                <ul className="mb-6 md:mb-0">
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 dark:text-slate-400">7th Floor, Bahria Complex IV, Chaudry Khaliq-uz-zaman Road, Gizri, Clifton</p>
                                    ...
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            ...
                                            <p className="text-gray-600 dark:text-slate-400">Mobile: +92 (0) 313 380 4073</p>
                                            <p className="text-gray-600 dark:text-slate-400">Mail: info@grr.com</p>
                                        </div>
                                    </li>
                                    <li className="flex">
                                        <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
