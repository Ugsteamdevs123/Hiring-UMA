            ...
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="sm:col-span-2">
                    <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
                        ...
                        <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Global Remote Recruits</span>
                    </a>
                    <div className="mt-6 lg:max-w-sm">
                        ...
                        Established in 2021, we are a B2B staffing service provider dedicated to facilitating seamless talent acquisition for businesses.
                        </p>
                    </div>
                </div>
                <div className="space-y-2 text-sm">
                    ...
                    <div className="flex">
                        ...
                        <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">+92 (0) 313 380 4073</a>
                    </div>
                    <div className="flex">
                        <p className="mr-1 text-gray-800">Email:</p>
                        <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">info@grr.com</a>
                    </div>
                    <div className="flex">
                        ...
                        7th Floor, Bahria Complex IV, Chaudry Khaliq-uz-zaman Road, Gizri, Clifton, Karachi.
                        </a>
                    </div>
                </div>
                <div>
                    ...
                    Share your information to access our Resource Pool
                    </p>
                </div>
            </div>
            <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                <p className="text-sm text-gray-600">
                    © All right reserved to GRR | Global Remote Recruits
                </p>
                <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
                    <li>
                        <Link to="/faq" className="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">F.A.Q</Link>
                    </li>
                    <li>
